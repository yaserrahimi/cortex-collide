...
├── tools/validate_i18n.js  # اسکریپت اعتبارسنجی تطابق کلیدهای ترجمه (EN/FA)
├── tools/test_i18n.js      # تست عملکردی موتور ترجمه و پرامپت‌های مناظره
├── generate_icons.js       # اسکریپت ساخت آیکون‌های استاندارد افزونه
